		...
		<div class="login-content-box">
			<div class="login-content-info">
				...
				<div class="login-waug-email-box">
					<form action="">
						<input type="email" class="login-form-box" placeholder="이메일" required="required">
						<input type="password" class="login-form-box" placeholder="비밀번호(영문, 숫자, 특수문자 8자리이상)" required="required">
						<input type="password" class="login-form-box" placeholder="비밀번호 확인" required="required">
						<input type="text" class="login-form-box" placeholder="이름" required="required">								
				...
				<div style="margin-top: -14px">
					...
					<div class="sign-up-event-agree-text login-sub-text" style="padding: 15px 5px 0px 5px;">회원가입을 함으로써 와그의 <span class="text-highlight">이용약관</span>
						, <span class="text-highlight">개인정보보호정책</span> 에 동의하시에 됩니다.</div>
				</div>			
			</div>
		</div>
	</div>
