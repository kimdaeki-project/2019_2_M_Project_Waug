...
<body>
	...
	<div class="good_img_wrapper">
      ...
      <div class="good_img_small_wrapper">
         <div class="good_img_small"><input type="file" name="file" class="subImg"></div>
         <div class="good_img_small"><input type="file" name="file" class="subImg"></div>      
      </div>
      <div class="good_img_small_wrapper">
        <div class="good_img_small">img 4<input type="file" name="file" class="subImg"></div>
        <div class="good_img_small">img 5<input type="file" name="file" class="subImg"></div> 
      </div>
      </div>
   </div>
      ...
      <div class="good_detailBox">
         <div class="good_info_wrapper">
         	<div class="good_info_padding">
         		<div class="good_info_area">Goods titile</div>
